...
Akina.addCommand({pattern: 'tg ?(.*)', fromMe: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
...
Akina.addCommand({pattern: 'stam$', fromMe: true, desc: stag_dsc }, (async (message, match) => {
