...
const array = ['name entha','admin','hi','hello','helo','mk','moko karanne']
...
const array = ['hi','isuru','achi','achintha','sandamini','sandali','umma','kukku','dukai','ane','anee','aneee','nidimathai']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
