...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    Akina.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Akina.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
